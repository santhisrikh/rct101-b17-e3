...
test("Login page works correctly", async () => {
  ...
  fetchMock.get("https://jsonplaceholder.typicode.com/photos?_page=1&_limit=10",200,{
    response: {
      body:[]
    }
  })
...
test("Dasbhoard page works correctly", async () => {
  ...
  fetchMock.get("https://jsonplaceholder.typicode.com/photos?_page=2&_limit=10",200,{
    response: {
      body: page2
    },
    overwriteRoutes: true
